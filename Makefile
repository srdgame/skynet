...
3rd/jemalloc/Makefile : | 3rd/jemalloc/autogen.sh
	cd 3rd/jemalloc && ./autogen.sh --disable-cxx --with-jemalloc-prefix=je_ --enable-prof $(JEMALLOC_FLAGS)
...
LUA_CLIB_MOSQ_INCLUDES = \
	-I3rd/lua-mosquitto/deps/mosquitto -I3rd/lua-mosquitto/deps/mosquitto/lib -I3rd/lua-mosquitto/deps/mosquitto/include -I3rd/lua-mosquitto -I3rd/lua-mosquitto/deps/mosquitto/deps
